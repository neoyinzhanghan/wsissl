...
dataset_dir = "/media/hdd1/neo//media/hdd1/neo/pancreas_SimCLR_data/pancreas_IMAGENET_SYM"
...
# randomly subssample the train, val, and test folders, and copy them to the mini_dataset_dir using the same folder structure and using symbolic links
