...
mini_dataset_dir = "/media/hdd2/neo/pancreas_DINOv2_data/pancreas_IMAGENET_SYM_small"
...
# randomly subssample the train, val, and test folders, and copy them to the mini_dataset_dir using the same folder structure
for folder in ["train", "val", "test"]:
    ...
    for image in tqdm(selected_images, desc=folder):
        # use shutil.copy to copy the images
        shutil.copy(os.path.join(dataset_dir, folder, "patch", image), os.path.join(mini_dataset_dir, folder, "patch", image))